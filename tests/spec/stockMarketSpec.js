describe('get_max_profit()', function() {
  describe('returns the minimal loss', function() {
    it('returns -2 for [12, 9, 7, 5, 3, 1]', function() {
      var array = [12, 9, 7, 5, 3, 1];
      expect(get_max_profit(array)).toEqual(-2); // returns 0
    });
    it('returns -1 for [10, 9, 8, 7, 6, 4]', function() {
    ...
    it('returns 0 for [12, 12]', function() {
      var array = [12, 12];
      expect(get_max_profit(array)).toEqual(0); // returns 0
    });
  });
